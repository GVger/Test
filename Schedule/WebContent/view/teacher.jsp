			...
			<div id="holder">
				<div id="menu">
					...
					<ul>
						...
						<li><a href="teacher.jsp" class="selected"><span>老师信息</span></a></li>
					...
					<div class="modules_left">
						<div class="module buttons">
							...
							<div class="dropdown">
								<div class="arrow"></div>
								<div class="content">
									<form id="teacherForm" action="insertTeacher.jsp" method="post">
										<p>
											<label for="teacherNo">老师编号：</label> <input type="text"
												class="text w_22" name="teacherNo" id="teacherNo" value="" />
										</p>
										<p>
											<label for="teacherName">老师名字：</label> <input type="text"
												class="text w_22" name="teacherName" id="teacherName"
												value="" />
										</p>
										<p>
											<label for="teachCourseName">任教科目：</label> <input type="text"
												class="text w_22" name="teachCourseName"
												id="teachCourseName" value="" />
										</p>
									</form>
									<a href="#" class="button green right"
										onclick="document.getElementById('teacherForm').submit();return false"><small
						...
						<div class="content">
							<table>
								...
								<%
									...
									int size = service.getTeacherData().size();
									if (size == 0) {
								%>
								<tr id="id_1">
								...
								<%
										...
										List<cn.vger.schedule.model.Teacher> teacherData = service.getTeacherData();
								...
								<tr id="id_<%=i%>">
									<td class="checkbox"><input type="checkbox"
										name="checkbox" /></td>
									<td><%=teacherData.get(i).getTeacherNo()%></td>
									<td><%=teacherData.get(i).getTeacherName()%></td>
									<td><%=teacherData.get(i).getTeachCourseName()%></td>
