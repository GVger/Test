			...
			<div id="holder">
				<div id="menu">
					...
					<ul>
						...
						<li><a href="class.jsp" class="selected"><span>班级信息</span></a>
						</li>
					...
					<div class="modules_left">
						<div class="module buttons">
							...
							<div class="dropdown">
								<div class="arrow"></div>
								<div class="content">
									<form id="classForm" action="insertClass.jsp" method="post">
										<p>
											<label for="classNo">班级编号：</label> <input type="text"
												class="text w_22" name="classNo" id="classNo" value="" />
										</p>
										<p>
											<label for="className">班级名字:</label> <input type="text"
												class="text w_22" name="className" id="className" value="" />
										</p>
									</form>
									<a href="#" class="button green right"
										onclick="document.getElementById('classForm').submit();return false"><small
						...
						<div class="content">
							<table>
								...
								<%
									...
									int size = service.getClassData().size();
									if (size == 0) {
								%>
								<tr id="id_1">
								...
								<%
										...
										List<cn.vger.schedule.model.Class> classData = service.getClassData();
								...
								<tr id="id_<%=i%>">
									<td class="checkbox"><input type="checkbox"
										name="checkbox" /></td>
									<td><%=classData.get(i).getClassNo()%></td>
									<td><%=classData.get(i).getClassName()%></td>
